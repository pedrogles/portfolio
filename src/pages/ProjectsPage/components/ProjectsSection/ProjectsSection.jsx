    ...
    const projects = [
        {
            ...
            ariaLabel: "Link para o site do Pro Reforma (abre em nova guia)"
        },
        {
            id: 1,
            ...
            text: "Visite clicando aqui.",
            ariaLabel: "Link para o site do Converx App (abre em nova guia)"
        },
        {
            id: 2,
            ...
            text: "Visite clicando aqui.",
            ariaLabel: "Link para o arquivo do Informativo TRE-PB (abre em nova guia)"
        },
        {
            id: 3,
            ...
            text: "Visite clicando aqui.",
            ariaLabel: "Link para o site da Bendita Beleza (abre em nova guia)"
        },
        {
            id: 4,
            ...
            text: "Visite clicando aqui.",
            ariaLabel: "Link para o arquivo do portfólio do Renato César (abre em nova guia)"
        }
    ];
    return (
        <Section>
